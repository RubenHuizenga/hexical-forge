...
object PrestidigitationHandlersHook {
	...
	fun createRegistry() {
 	...
 	val TOGGLE_COMPARATOR : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("toggle_comparator") {
	...
	val CARVE_PUMPKIN : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("carve_pumpkin") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val AXEING : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("axeing") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val PATHING : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("pathing") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val PRESS_BUTTONS : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("press_buttons") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val EXTINGUISH_FIRES : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("extinguish_fires") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val CREATE_SOUL_FIRE : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("create_soul_fire") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val PRESSURE_PRESSURE_PLATES : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("pressure_pressure_plates") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val DRAIN_CAULDRONS : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("drain_cauldrons") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val LIGHT_CANDLE : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("light_candle") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val OPEN_DOORS : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("open_doors") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val STEAL_HONEY : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("steal_honey") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
	...
	val PLAY_NOTE : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("play_note") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val RING_BELL : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("ring_bell") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val DISPENSE : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("dispense") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val PRIME_TNT : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("prime_tnt") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				val state = env.world.getBlockState(position)
	...
	val LEARN_AKASHIC : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("learn_akashic") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
	...
	val TRIGGER_IMPETUS : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("trigger_impetus") {
		object : PrestidigitationHandler {
			override fun tryHandleBlock(env: CastingEnvironment, position: BlockPos): Boolean {
				if (env.castingEntity !is ServerPlayer)
					return false
	...
	val ARM_ARMOR_STANDS : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("arm_armor_stands") {
		object : PrestidigitationHandler {
	...
	val DEPRIME_TNT : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("deprime_tnt") {
		object : PrestidigitationHandler {
			override fun tryHandleEntity(env: CastingEnvironment, entity: Entity): Boolean {
	...
	val SHEAR : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("shear") {
		object : PrestidigitationHandler {
			override fun tryHandleEntity(env: CastingEnvironment, entity: Entity): Boolean {
	...
	val MILK_SQUIDS : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("milk_squids") {
		object : PrestidigitationHandler {
			override fun tryHandleEntity(env: CastingEnvironment, entity: Entity): Boolean {
				if (entity !is Squid)
					return false
	...
	val PANDAS_SNEEZE : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("pandas_sneeze") {
		object : PrestidigitationHandler {
			override fun tryHandleEntity(env: CastingEnvironment, entity: Entity): Boolean {
				if (entity !is Panda)
					return false
	...
	val TEASE_CREEPERS : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("tease_creepers") {
		object : PrestidigitationHandler {
			override fun tryHandleEntity(env: CastingEnvironment, entity: Entity): Boolean {
	...
	val PUFF_PUFFERFISH : RegistryObject<PrestidigitationHandler> = PRESTIDIGITATION_HANDLER.register("puff_pufferfish") {
		object : PrestidigitationHandler {
			override fun tryHandleEntity(env: CastingEnvironment, entity: Entity): Boolean {
